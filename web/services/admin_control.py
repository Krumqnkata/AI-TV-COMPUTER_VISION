...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("features.badge_jokes_enabled", "Забавен режим", "Шеги при сканиране", "Добавя кратка одобрена шега към поздрава след успешно сканиране на бадж.", "boolean", True),
    SettingDefinition("features.badge_jokes_frequency", "Забавен режим", "Честота на шегите", "Процент от успешните сканирания, при които да се избира шега.", "integer", 35, 0, 100),
    SettingDefinition("features.badge_jokes_auto_speak", "Забавен режим", "Прочитай шегата на глас", "Киоскът автоматично прочита само шегата, без личните съобщения.", "boolean", True),
